...
export default function App() {
  ...
  // handleMove function are newly defined function for every render.
  // Therefore, move the handleMove function inside the Effect. 
  // Then handleMove won’t be a reactive value, 
  // and so your Effect won’t depend on a function.
  useEffect(() => {
    function handleMove(e) {
      if (canMove) {
        setPosition({ x: e.clientX, y: e.clientY });
